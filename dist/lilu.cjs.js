...
const dParse = debug__default['default']('lilu:expression:parse');
const dCast = debug__default['default']('lilu:expression:cast');
...
function castExpression(str) {
  try {
    ...
    const ast = esprima__default['default'].parse(str).body[0].expression;
...
const d = debug__default['default']('lilu:expression:eval');
const dError = debug__default['default']('lilu:expression:eval:error');
